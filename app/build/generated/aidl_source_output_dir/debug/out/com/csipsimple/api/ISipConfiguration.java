...
{
  /** Default implementation for ISipConfiguration. */
  public static class Default implements com.csipsimple.api.ISipConfiguration
  {
    //Prefs
  ...
  public static abstract class Stub extends android.os.Binder implements com.csipsimple.api.ISipConfiguration
  {
    ...
    private static class Proxy implements com.csipsimple.api.ISipConfiguration
    {
      ...
      @Override public void setPreferenceString(java.lang.String key, java.lang.String value) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_setPreferenceString, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().setPreferenceString(key, value);
            return;
          }
      ...
      @Override public void setPreferenceBoolean(java.lang.String key, boolean value) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_setPreferenceBoolean, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().setPreferenceBoolean(key, value);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public void setPreferenceFloat(java.lang.String key, float value) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_setPreferenceFloat, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().setPreferenceFloat(key, value);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public java.lang.String getPreferenceString(java.lang.String key) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeString(key);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getPreferenceString, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getPreferenceString(key);
          }
          _reply.readException();
      ...
      @Override public boolean getPreferenceBoolean(java.lang.String key) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeString(key);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getPreferenceBoolean, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getPreferenceBoolean(key);
          }
          _reply.readException();
      ...
      @Override public float getPreferenceFloat(java.lang.String key) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeString(key);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getPreferenceFloat, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getPreferenceFloat(key);
          }
          _reply.readException();
      ...
      public static com.csipsimple.api.ISipConfiguration sDefaultImpl;
    }
    ...
    public static boolean setDefaultImpl(com.csipsimple.api.ISipConfiguration impl) {
    ...
    public static com.csipsimple.api.ISipConfiguration getDefaultImpl() {
