...
public abstract class AccountsChooserListActivity extends Activity implements OnAccountClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listFragment = (AccountsChooserListFragment) getFragmentManager().findFragmentById(R.id.listFragment);
