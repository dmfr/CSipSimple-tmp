	...
	public int delete(Uri uri, String where, String[] whereArgs) {
        ...
        switch (matched) {
            ...
            case CALLLOGS:
            	...
            	break;
            case CALLLOGS_ID:
            	finalWhere = DatabaseUtils.concatenateWhere(CallLog.Calls._ID + " = " + ContentUris.parseId(uri), where);
            ...
            case FILTERS:
            	...
            	break;
            case FILTERS_ID:
            	finalWhere = DatabaseUtils.concatenateWhere(Filter._ID + " = " + ContentUris.parseId(uri), where);
